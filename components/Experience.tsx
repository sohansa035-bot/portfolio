      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="glassmorphism p-8 rounded-3xl group hover:border-blue-500/50 transition-colors">
            ...
            <h3 className="text-xl font-bold mb-2">Technical Co-Head</h3>
            <div className="text-blue-400 font-medium mb-6">IEEE TEMS REVA University</div>
            
            <div className="space-y-4">
              <div>
                <h4 className="text-sm text-neutral-400 uppercase tracking-wider font-semibold mb-2">Responsibilities</h4>
                <ul className="space-y-2 text-neutral-300 text-sm list-inside list-disc">
              ...
              <div className="pt-4 border-t border-white/10">
                <h4 className="text-sm text-neutral-400 uppercase tracking-wider font-semibold mb-2">Skills & Outcomes</h4>
          ...
          <div className="glassmorphism p-8 rounded-3xl group hover:border-blue-500/50 transition-colors">
            ...
            <h3 className="text-xl font-bold mb-2">Technology Intern</h3>
            <div className="text-blue-400 font-medium mb-6">OptCell Global</div>
            
            <div className="space-y-4">
              <div>
                <h4 className="text-sm text-neutral-400 uppercase tracking-wider font-semibold mb-2">Key Responsibilities</h4>
                <ul className="space-y-2 text-neutral-300 text-sm list-inside list-disc">
