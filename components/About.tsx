      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="space-y-6 text-lg text-neutral-300">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 bg-white/5 p-6 rounded-3xl border border-white/10 shadow-lg">
              <div className="w-32 h-32 md:w-36 md:h-36 rounded-2xl overflow-hidden border-2 border-white/10 shadow-[0_0_30px_rgba(59,130,246,0.2)] relative shrink-0 transition-transform hover:scale-105 duration-300">
                <Image src="/mypic.jpeg" alt="Sohan Saha" fill className="object-cover" />
              </div>
              <p className="text-xl text-white leading-relaxed text-center md:text-left mt-2 md:mt-0">
                Hello! I&apos;m <strong className="text-blue-400">Sohan Saha</strong>, a passionate Artificial Intelligence and Machine Learning student at REVA University.
              </p>
            </div>
            <p>
          ...
          <div className="glassmorphism p-8 rounded-3xl space-y-6 relative overflow-hidden">
            ...
            <div>
              <div className="text-xl font-bold text-blue-400 mb-1">Bachelor of Technology (B.Tech)</div>
              <div className="text-neutral-300 font-medium mb-4">Artificial Intelligence & Machine Learning</div>
              
              <div className="space-y-3 text-sm text-neutral-400">
                <div className="flex justify-between border-b border-white/10 pb-2">
                  <span>University</span>
                  <span className="text-white">REVA University</span>
                </div>
                <div className="flex justify-between border-b border-white/10 pb-2">
                  <span>Location</span>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-medium bg-white/10 px-2 py-1 rounded">2nd Semester</span>
                </div>
              </div>
            </div>
          </div>
